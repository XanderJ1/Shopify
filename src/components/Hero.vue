...
<template>
        ...
        <div class="flex-col mx-auto p-4 mb-10">    
        ...
        <div class="top container grid grid-cols-4 gap-2 mx-auto mt-2">
            <div class="clothing cursor-pointer">
                <img class="w-60 h-60 mx-4 border border-gray-200 rounded-2xl" src="../assets/images/clothing.jpg">
                <h2 class="text-2xl mt-2 text-center">Clothing</h2>
            </div>
            <div class="kids cursor-pointer">
                <img class="w-60 h-60 mx-4 border border-gray-200 rounded-2xl" src="../assets/images/kids.jpg">
                <h2 class="text-2xl mt-2 text-center">Kids</h2>
            </div>
            <div class="electronics cursor-pointer">
                <img class="w-60 h-60 mx-4 border border-gray-200 rounded-2xl" src="../assets/images/laptop.jpg">
                <h2 class="text-2xl mt-2 text-center">Electronics</h2>
            </div>
            <div class="accessories cursor-pointer">
                <img class="w-60 h-60 mx-4 border border-gray-200 rounded-2xl" src="../assets/images/pexels-pixabay-277390.jpg">
